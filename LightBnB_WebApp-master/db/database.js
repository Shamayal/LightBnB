...
const getAllProperties = function(options, limit = 10) {
  ...
  // 3 - WHERE clause for different options
  if (options.city) {
  ...
  // 5 - checking if everything is correct
...
const addProperty = (property) => {
  return pool
    ...
    .then((result) => {
      //console.log("check property:", result) I created "Random House" listing in Toronto
      return result.rows[0];
    })
    .catch((err) => {
      console.log(err.message);
